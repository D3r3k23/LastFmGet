...
def main():
    ...
    parser.add_argument('--methods_module_fn', '-m', default=os.path.join('src', 'lastfmget', 'raw_methods.py'))
...
def write_methods_module_lines(methods, methodsyamlfn):
    ...
    lines.append(f'Module generated by gen_methods_module.py from {src}')
    lines.append('"""')
